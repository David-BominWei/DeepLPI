...
seqembed_path = "/home/wbm001/deeplpi/data/davis/seq_300.csv"
...
scheduler = optim.lr_scheduler.ReduceLROnPlateau(optimizer, 'min', factor=0.5, min_lr=0.00001)
